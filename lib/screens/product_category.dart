...
class TabbedAppBarCategory extends StatefulWidget {
  @override
  _TabbedAppBarCategoryState createState() => new _TabbedAppBarCategoryState();
}
class _TabbedAppBarCategoryState extends State<TabbedAppBarCategory> {
  ...
  Widget build(BuildContext context) {
    ...
    final makeTab = FutureBuilder<List<_categoryName.Category>>(
          ...
          return DefaultTabController(
            ...
            child: Scaffold(
              appBar: AppBar(
                ...
                centerTitle: true,
                title: new Text('หมวดหมู่',style: new TextStyle(color: cl_text_pro_th),),
                bottom: TabBar(
                  isScrollable: true,
                      ...
                      children: <Widget>[
                        ...
                        Expanded(
                          child: _searchResult.length != 0 || controller.text.isNotEmpty
                              ? _buildSearchResults()
                              : _buildUsersList(cate.CategoryID),
                        ),
